...
#define MODEL_PATH	"../VAServer/vaserver/models/deploy_mobile.prototxt"
#define WEIGHTS_PATH "../VAServer/vaserver/models/bvlc_reference_caffenet.caffemodel"
#define MEAN_PATH	"../VAServer/vaserver/models/arl/mean.binaryproto"
#define SYNSET_PATH	"../VAServer/vaserver/models/synset_words.txt"
